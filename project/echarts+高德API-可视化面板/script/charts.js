...
function chart_1() {
  ...
  var info = [
    {
      ...
      "used": 49,
      "code": "0000",
      "position": [114.069988, 22.720475]
    },
    {
      "name": "站点B",
      "used": 96,
      "code": "1111",
      "position": [114.064495, 22.717585]
    },
    {
      "name": "站点C",
      "used": 67,
      "code": "2222",
      "position": [114.071951, 22.722934]
    }
  ];
  // TODO:以上为后端数据
  ...
  for (let i = 0; i < info.length; i++) {
    ...
    rest_count.push(info[i].used / 100);
  }
  rest_garbage(names, rest_count);
}
function rest_garbage(category, data) {
  var myChart = echarts.init(document.querySelector("#rest_garbage"));
  var color = [];
...
function chart_2() {
  ...
  // 图例
  var legend_data = ['可回收', '其他', '厨余', '有害'];
  // 横坐标---车辆编号
  var cars = [];
  // 纵坐标
  var value = [];
  for (let i = 0; i < info.length; i++) {
    cars.push(info[i].name);
    value.push(info[i].data);
  }

  car_status(legend_data, cars, value);
}
function car_status(legend_data, cars, value) {
  ...
  var option = {
    ...
    color: ['#24adfe', 'gray', '#42a785', '#c44341'],
    series: [
      { name: '可回收', type: 'bar', barWidth: 24, stack: 'total', data: value[0] },
      { name: '其他', type: 'bar', barWidth: 24, stack: 'total', data: value[1] },
      { name: '厨余', type: 'bar', barWidth: 24, stack: 'total', data: value[2] },
      { name: '有害', type: 'bar', barWidth: 24, stack: 'total', data: value[3] },
    ],
  };
...
function year_statistic() {
  var chartDom = document.getElementById('statistic_chart');
  ...
  option = {
    baseOption: {
      ...
      series: [
        { name: '可回收垃圾', type: 'bar', color: '#154360' },
        { name: '厨余垃圾', type: 'bar', color: '#0e6251' },
        { name: '其他垃圾', type: 'bar', color: '#e59866' },
        { name: '有害垃圾', type: 'bar', color: '#e74c3c' },
        {
          name: '垃圾分类占比',
          type: 'pie',
          center: ['80%', '30%'],
          ...
          color: ['#154360', '#0e6251', '#e59866', '#e74c3c'],
          // formatter: '{a}:{d}%',
          tooltip: {
            formatter: '{b}:{d}%',
          },
    ...
    options: [
      {
        ...
        series: [
          ...
          {
            data: [
              { name: '可回收垃圾', value: dataMap.dataGDP['2002sum'] },
              { name: '厨余垃圾', value: dataMap.dataSI['2002sum'] },
              { name: '其他垃圾', value: dataMap.dataTI['2002sum'] },
              { name: '有害垃圾', value: dataMap.dataPI['2002sum'] },
            ]
          }
        ]
      },
      {
        title: { text: '2017年深圳市垃圾分类统计' },
        series: [
          ...
          {
            data: [
              { name: '可回收垃圾', value: dataMap.dataGDP['2003sum'] },
              { name: '厨余垃圾', value: dataMap.dataSI['2003sum'] },
              { name: '其他垃圾', value: dataMap.dataTI['2003sum'] },
              { name: '有害垃圾', value: dataMap.dataPI['2003sum'] },
            ]
          }
        ]
      },
      {
        title: { text: '2018年深圳市垃圾分类统计' },
        series: [
          ...
          {
            data: [
              { name: '可回收垃圾', value: dataMap.dataGDP['2004sum'] },
              { name: '厨余垃圾', value: dataMap.dataSI['2004sum'] },
              { name: '其他垃圾', value: dataMap.dataTI['2004sum'] },
              { name: '有害垃圾', value: dataMap.dataPI['2004sum'] },
            ]
          }
        ]
      },
      {
        title: { text: '2019年深圳市垃圾分类统计' },
        series: [
          ...
          {
            data: [
              { name: '可回收垃圾', value: dataMap.dataGDP['2005sum'] },
              { name: '厨余垃圾', value: dataMap.dataSI['2005sum'] },
              { name: '其他垃圾', value: dataMap.dataTI['2005sum'] },
              { name: '有害垃圾', value: dataMap.dataPI['2005sum'] },
            ]
          }
        ]
      },
      {
        title: { text: '2020年深圳市垃圾分类统计' },
        series: [
          ...
          {
            data: [
              { name: '可回收垃圾', value: dataMap.dataGDP['2006sum'] },
              { name: '厨余垃圾', value: dataMap.dataSI['2006sum'] },
              { name: '其他垃圾', value: dataMap.dataTI['2006sum'] },
              { name: '有害垃圾', value: dataMap.dataPI['2006sum'] },
            ]
          }
        ]
      },
      {
        title: { text: '2021年深圳市垃圾分类统计' },
        series: [
          ...
          {
            data: [
              { name: '可回收垃圾', value: dataMap.dataGDP['2007sum'] },
              { name: '厨余垃圾', value: dataMap.dataSI['2007sum'] },
              { name: '其他垃圾', value: dataMap.dataTI['2007sum'] },
              { name: '有害垃圾', value: dataMap.dataPI['2007sum'] },
            ]
          }
        ]
      },
...
function chart_4() {
  // TODO:后端数据
  var info = [
    [72, 37, 4, 75, 23, 89],//可回收垃圾
    [8, 15, 34, 31, 28, 29],//其他垃圾
    [19, 20, 86, 21, 89, 101],//厨余垃圾
    [80, 15, 24, 43, 100, 76]//有害垃圾
  ]
  // TODO:以上为后端数据

  var xData = ["6:00", "9:00", "12:00", "15:00", "18:00", "21:00"];
  var legendData = ["可回收", "其他", "厨余", "有害"]; //图例
  var garbageData = info;

  day_statistic(xData, legendData, garbageData);
}
function day_statistic(xData, legendData, garbageData) {
  var myChart = echarts.init(document.querySelector("#day_chart"));
      ...
      },
      {
        ...
        areaStyle: {
          ...
          color: {
            ...
            y2: 1,
            colorStops: [{
              offset: 0, color: 'rgba(32,37,37, 0.8)' // 0% 处的颜色
            }, {
              offset: 1, color: 'rgba(102,113,114, 0.8)' // 100% 处的颜色
            }],
            global: false // 缺省为 false
          }
        }
      },
      {
        ...
        areaStyle: {
          ...
          color: {
            ...
            y2: 1,
            colorStops: [{
              offset: 0, color: 'rgba(3,203,136, 0.8)' // 0% 处的颜色
            }, {
              offset: 1, color: 'rgba(103,238,193, 0.1)' // 100% 处的颜色
            }],
            global: false // 缺省为 false
          }
        }
      },
      {
        ...
        areaStyle: {
          ...
          color: {
            ...
            y2: 1,
            colorStops: [{
              offset: 0, color: 'rgba(240,3,6, 0.8)' // 0% 处的颜色
            }, {
              offset: 1, color: 'rgba(242,138,140, 0.8)' // 100% 处的颜色
            }],
            global: false // 缺省为 false
          }
        }
